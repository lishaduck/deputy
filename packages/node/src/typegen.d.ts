...
// ----- n/callback-return -----
/** @internal */
export type NCallbackReturn = []|[string[]]
// ----- n/exports-style -----
/** @internal */
export type NExportsStyle = []|[("module.exports" | "exports")]|[("module.exports" | "exports"), {
  allowBatchAssign?: boolean
}]
// ----- n/file-extension-in-import -----
/** @internal */
export type NFileExtensionInImport = []|[("always" | "never")]|[("always" | "never"), {
  [k: string]: ("always" | "never") | undefined
}]
// ----- n/handle-callback-err -----
/** @internal */
export type NHandleCallbackErr = []|[string]
// ----- n/hashbang -----
/** @internal */
export type NHashbang = []|[{
  convertPath?: ({
...
/** @internal */
export type NNoExtraneousImport = []|[{
  allowModules?: string[]
  convertPath?: ({
...
/** @internal */
export type NNoExtraneousRequire = []|[{
  allowModules?: string[]
  convertPath?: ({
...
/** @internal */
export type NNoHideCoreModules = []|[{
...
// ----- n/no-mixed-requires -----
/** @internal */
export type NNoMixedRequires = []|[(boolean | {
  grouping?: boolean
  allowCall?: boolean
})]
// ----- n/no-process-env -----
/** @internal */
export type NNoProcessEnv = []|[{
  allowedVariables?: string[]
}]
// ----- n/no-restricted-import -----
/** @internal */
export type NNoRestrictedImport = []|[(string | {
  name: (string | string[])
  message?: string
})[]]
// ----- n/no-restricted-require -----
/** @internal */
export type NNoRestrictedRequire = []|[(string | {
  name: (string | string[])
  message?: string
})[]]
// ----- n/no-sync -----
...
/** @internal */
export type NNoUnpublishedImport = []|[{
  allowModules?: string[]
  convertPath?: ({
...
/** @internal */
export type NNoUnpublishedRequire = []|[{
  allowModules?: string[]
  convertPath?: ({
...
/** @internal */
export type NNoUnsupportedFeaturesEsBuiltins = []|[{
  version?: string
...
/** @internal */
export type NNoUnsupportedFeaturesEsSyntax = []|[{
  version?: string
...
/** @internal */
export type NNoUnsupportedFeaturesNodeBuiltins = []|[{
  version?: string
...
/** @internal */
export type NPreferGlobalBuffer = []|[("always" | "never")]
// ----- n/prefer-global/console -----
/** @internal */
export type NPreferGlobalConsole = []|[("always" | "never")]
// ----- n/prefer-global/process -----
/** @internal */
export type NPreferGlobalProcess = []|[("always" | "never")]
// ----- n/prefer-global/text-decoder -----
/** @internal */
export type NPreferGlobalTextDecoder = []|[("always" | "never")]
// ----- n/prefer-global/text-encoder -----
/** @internal */
export type NPreferGlobalTextEncoder = []|[("always" | "never")]
// ----- n/prefer-global/url -----
/** @internal */
export type NPreferGlobalUrl = []|[("always" | "never")]
// ----- n/prefer-global/url-search-params -----
/** @internal */
export type NPreferGlobalUrlSearchParams = []|[("always" | "never")]
// ----- n/prefer-node-protocol -----
/** @internal */
export type NPreferNodeProtocol = []|[{
  version?: string
}]
// ----- n/shebang -----
/** @internal */
export type NShebang = []|[{
  convertPath?: ({
